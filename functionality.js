...
function chaange() {
  $('.dabba').removeClass("border border-[2px] border-blue-400");
  if (selectedTool == 'textTool') {
    $('.dabba').removeClass('hidden');
  }
  // document.querySelector(`#${selectedTool}`).classList.remove("border");
  $(`#${selectedTool}`).addClass("border border-blue-400 border-[2px] rounded-md");
  // btn.classList.add("border border-blue-500");
